...
import {nUSDVault} from "../src/nUSDVault.sol";
import {nUSD} from "../src/nUSD.sol";
import {MockERC20} from "solmate/test/utils/mocks/MockERC20.sol";
import {VaultRegularBorrowable, VaultSimple} from "evc-playground/vaults/open-zeppelin/VaultRegularBorrowable.sol";

import {IEVC} from "ethereum-vault-connector/interfaces/IEthereumVaultConnector.sol";
import {EthereumVaultConnector} from "ethereum-vault-connector/EthereumVaultConnector.sol";
import {EVCUtil} from "ethereum-vault-connector/utils/EVCUtil.sol";

import {IRMMock} from "../lib/evc-playground/test/mocks/IRMMock.sol";
import {PriceOracleMock} from "../lib/evc-playground/test/mocks/PriceOracleMock.sol";

contract nUSDVaultTest is Test {
    ...
    function setUp() public {
        ...
        liabilityAsset = new nUSD(address(evc), "Liability Asset", "LA");
    ...
    function mintAndApprove(address alice, address bob) public {
        liabilityAsset.setCapacity(address(this), 100e18);
